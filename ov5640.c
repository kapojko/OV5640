...
int32_t OV5640_Init(OV5640_Object_t *pObj, uint32_t Resolution, uint32_t PixelFormat)
{
  ...
  static const uint16_t OV5640_Common[][2] =
  {
    ...
    {0x460b, 0x35},
    {0x460c, 0x23},
    {OV5640_PCLK_PERIOD, 0x22}, // PCLK divider
    {0x3824, 0x02}, // DVP CLK divider 
    {OV5640_ISP_CONTROL00, 0xa7}, // Lenc on, raw gamma on, BPC on, WPC on, CIP on // AEC target    自动曝光控制
...
int OV5640_EnableDVPMode(OV5640_Object_t *pObj)
{
  ...
  static const uint16_t regs[10][2] =
  {
    ...
    {OV5640_SC_PLL_CONTRL1, 0x41}, // Bit[7:4]: System clock divider (Slow down all clocks)
